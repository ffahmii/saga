 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://services.bank.com/", wsdlLocation = "http://localhost:8080/BankSaga/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://services.bank.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BankSaga/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://services.bank.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.bank.com/", "NewWebServicePort"), NewWebService.class, features);
    }
